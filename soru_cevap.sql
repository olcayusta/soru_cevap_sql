...
COPY public.note (id, title, content) FROM stdin;
1	Post Title 1	\N
\.
...
--
-- Name: chat_message chat_message_chat_room_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chat_message
    ADD CONSTRAINT chat_message_chat_room_id_fk FOREIGN KEY ("roomId") REFERENCES public.chat_room(id);
